    ...
    <div>
      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          {
            isEdit
            ? <button onClick={updateProfile} className='px-4 py-1 border border-pimary text-sm rounded-full mt-5 hover:bg-[#5F6FFF] hover:text-white transition-all cursor-pointer'>Save</button>
            : <button onClick={()=>setIsEdit(true)} className='px-4 py-1 border border-pimary text-sm rounded-full mt-5 hover:bg-[#5F6FFF] hover:text-white transition-all cursor-pointer'>Edit</button> 
          }
